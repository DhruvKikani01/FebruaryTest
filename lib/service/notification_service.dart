...
import 'package:testfebruary/seconds.dart';
import 'package:testfebruary/main.dart';
...
class NotificationService {
  ...
  configureSelectNotificationSubject() {
    selectNotificationStream.stream.listen((dynamic payload) async {
      Navigator.push(KeyTest.currentContext!, MaterialPageRoute(builder: (BuildContext context){
        return  SecondScreen();
      }));
    });
  }
